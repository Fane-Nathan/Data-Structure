 ...
 *
 * The Node struct contains a key-value pair, where the key is a string and the
 * value is an integer. It also contains a pointer to the next node in the hash
 * table.
 */
typedef struct Node {
