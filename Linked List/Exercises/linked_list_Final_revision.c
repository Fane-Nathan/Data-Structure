...
void delete(int data){
    ...
    // checking if the data field of the node called temp pointing to is equal to the value of data.
    if (temp->data == data){
        head = temp->next;
        free(temp);
        return;
    ...
    while (temp->next != NULL){
        ...
        // if the data field of the node that is being pointed to by the next field of the node called temp is equal to the value of data 
