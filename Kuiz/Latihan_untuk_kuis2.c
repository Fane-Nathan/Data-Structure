...
char *name() {
  ...
  printf("Please input rubik's name [No limits!] (ENTER HOW LONG YOU WANT THIS "
         "IS JUST A TEST FOR MY PROGRAM): ");
...
char *magnetic() {
  ...
  do {
    price =
        getInput("Please input Rubik price [Rp. 200,000 - Rp. 300,000]: ", 20);
...
char *nonMagnetic() {
  ...
  do {
    price =
        getInput("Please input Rubik price [Rp. 50,000 - Rp. 150,000]: ", 20);
...
char *getRubiksType() {
  ...
  do {
    type = getInput("Please input rubik's type [Magnetic / Non-Magnetic] [Case "
                    "sensitive]: ",
                    20);
...
Node *addRubiks(Node **head, Node **tail, Node *hashTable[]) {
  ...
  addRubik->price =
      processType(addRubik->rubiksType, "Magnetic", "Non-Magnetic");
...
void switchCase(int userChoice, Node **head, Node **tail, Node *hashTable[],
                int size) {
  switch (userChoice) {
  case 1: {
  ...
  case 3: {
    ...
    Node *deletedRubiks = deleteRubiks(
        hashTable, getInput("Please input rubik's ID to delete: ", 20));
