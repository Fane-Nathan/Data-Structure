...
void createList(char *word) {
  ...
  if (head == NULL) {
    head = newNode;
    // If the head is not NULL, then traverse the list to the end and add the
    // new node.
  } else {
    Node *temp = head;
  ...
  do {
    ...
    case 3:
      ...
      if (strcmp(answer2, "Y") == 0 || strcmp(answer2, "y") == 0 ||
          strcmp(answer2, "yes") == 0 || strcmp(answer2, "YES") == 0 ||
    ...
    case 4:
      ...
      char answer3[4];
      scanf("%s", &answer3);
      if (strcmp(answer3, "Y") == 0 || strcmp(answer3, "y") == 0 ||
          strcmp(answer3, "yes") == 0 || strcmp(answer3, "YES") == 0 ||
    ...
    case 6:
      do {
        printf("\nEnter the ASCII sum: "); // Look it is easier for me to find
                                           // the ASCII sum so deal with it
        ...
        char answer4[4];
        scanf("%s", &answer4);
        if (strcmp(answer4, "Y") == 0 || strcmp(answer4, "y") == 0 ||
            strcmp(answer4, "yes") == 0 || strcmp(answer4, "YES") == 0 ||
            strcmp(answer4, "Yes") == 0) {
